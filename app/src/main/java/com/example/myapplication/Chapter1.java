...
public class Chapter1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        soundQuestion1 = sound.load(this, R.raw.onev, 1);
        soundQuestion2 = sound.load(this, R.raw.eightv, 1);
        soundQuestion3 = sound.load(this, R.raw.fourv, 1);
        soundQuestion4 = sound.load(this, R.raw.sevenv, 1);
