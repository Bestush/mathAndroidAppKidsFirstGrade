...
public class ChapterOneNumbers extends AppCompatActivity {
    Button myButton1;
    Button myNumber;
    Button myButton2;
    ...
    private int soundOne, soundTwo, soundThree, soundFour, soundFive;
...
//    private boolean falseAnswer =false;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chapter_one_numbers);
    ...
    public void playNumber(View v) {
        switch (myClassObject.position) {
            ...
            case 0:
                sound.play(soundOne, 1, 1, 0, 0, 1);

                break;
            case 1:
                sound.play(soundTwo, 1, 1, 0, 0, 1);
                break;
            case 2:
                sound.play(soundThree, 1, 1, 0, 0, 1);
                break;
            case 3:
                sound.play(soundFour, 1, 1, 0, 0, 1);
                break;
            case 4:
                sound.play(soundFive, 1, 1, 0, 0, 1);
                break;
    ...
    public  void goHome(View v){
        Intent goHome = new Intent(ChapterOneNumbers.this, MainActivity.class);
